...
public class SongUtil {
    ...
    public static List<Song> getSongList() {
        ...
        String[] listComments = {
                ...
                "The music of Iceland includes vibrant folk and pop traditions. Well-known artists selectFrom Iceland include medieval music group Voces Thules, alternative rock band The Sugarcubes, singers Björk and Emiliana Torrini, post-rock band Sigur Rós and indie folk/indie pop band Of Monsters and Men.",
